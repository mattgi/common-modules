// lifted from https://raw.githubusercontent.com/eriktufvesson/ngBootbox/master/dist/ngBootbox.js
// Didn't have a dialog svc method, so brought in and refactored.

angular.module('ngBootbox', [])
  .directive('ngBootboxAlert', [
    function() {
      return {
        restrict: 'A',
        scope: false,
  ...
  .directive('ngBootboxCustomDialog', [
    '$templateCache',
    '$compile',
    '$q',
    '$http',
